...
CREATE TABLE `pedidos_produtos` (
  ...
  PRIMARY KEY (`CODIGO`),
  KEY `fk_PEDIDOS_PRODUTOS_PEDIDOS1_idx` (`PEDIDOS_CODIGO`),
  KEY `fk_PEDIDOS_PRODUTOS_PRODUTOS1_idx` (`PRODUTOS_CODIGO`),
  CONSTRAINT `fk_PEDIDOS_PRODUTOS_PEDIDOS1` FOREIGN KEY (`PEDIDOS_CODIGO`) REFERENCES `pedidos` (`CODIGO`),
  CONSTRAINT `fk_PEDIDOS_PRODUTOS_PRODUTOS1` FOREIGN KEY (`PRODUTOS_CODIGO`) REFERENCES `produtos` (`CODIGO`)
...
INSERT INTO `pedidos_produtos` VALUES (3,4,2,1,750,'750'),(4,5,6,1,29.9,'29.9');
